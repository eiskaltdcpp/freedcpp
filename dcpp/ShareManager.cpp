...
void ShareManager::on(QueueManagerListener::Finished, QueueItem* qi, const string& dir, int64_t speed) noexcept {
...
void ShareManager::on(TimerManagerListener::Minute, uint32_t tick) noexcept {
