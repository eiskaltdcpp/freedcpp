...
public:
	...
	virtual ~CountOutputStream() noexcept { if(managed) delete s; }
...
public:
	...
	virtual ~CalcOutputStream() noexcept { if(managed) delete s; }
...
public:
	...
	virtual ~CalcInputStream() noexcept { if(managed) delete s; }
...
public:
	...
	~FilteredOutputStream() noexcept { if(manage) delete f; }
...
public:
	...
	virtual ~FilteredInputStream() noexcept { if(managed) delete f; }
