...
public:
	FavoriteHubEntry() noexcept : encoding(Text::systemCharset) { }
	FavoriteHubEntry(const HubEntry& rhs) noexcept : name(rhs.getName()), server(rhs.getServer()),
		description(rhs.getDescription()), encoding(Text::systemCharset) { }
	FavoriteHubEntry(const FavoriteHubEntry& rhs) noexcept : userdescription(rhs.userdescription),
